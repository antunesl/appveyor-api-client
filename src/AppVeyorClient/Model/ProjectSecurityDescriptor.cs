...
{
    [DataContract]
    public partial class ProjectSecurityDescriptor : IEquatable<ProjectSecurityDescriptor>//, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectSecurityDescriptor(List<ProjectSecurityDescriptorAccessRightDefinition> AccessRightDefinitions = default(List<ProjectSecurityDescriptorAccessRightDefinition>), List<ProjectSecurityDescriptorRoleAce> RoleAces = default(List<ProjectSecurityDescriptorRoleAce>))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProjectSecurityDescriptor);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ProjectSecurityDescriptor other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
